...
nohup python3 -m http.server 8001 > ../../http_server.log 2>&1 &

sleep 2

echo "[+] Starting Chromium in kiosk mode..."
DISPLAY=:0 exec chromium-browser --kiosk http://localhost:8001 --noerrdialogs --disable-infobars --no-sandbox
